          ...
          <div>
              ...
              <div className="container mx-auto px-6 py-12 flex flex-wrap">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                  <div className=" rounded-lg border text-slate-400 w-[90%]">
                    ...
                    <br />
                    <p className="text-lg">
                      {`Experience our services free without signup Avail free Tokenn to get the query generated by ADIRA 
                `}
                    </p>
                    <br />
                    <h2
                  ...
                  <div className=" rounded-lg border text-slate-400 w-[90%]">
                    ...
                    <br />
                    <p className="text-lg">
                      {`Explore our services exclusively by signup, Avail Unlimited Tokens to get the query generated by ADIRA 
                `}
                    </p>
                    <br />
                    <h2
            ...
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
                  ...
                  <div className=" rounded-lg border text-slate-400 w-[90%]">
                    ...
                    <br />
                    <p className="text-lg">
                      {`Premium Members can access our consultation services WorldWide, Connect to vast network of lawyers
                `}
                    </p>
                    <br />
                    <h2
